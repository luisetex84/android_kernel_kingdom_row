...
//#define	OISFW_RELEASE_VER (0xA1A1)	//LC898122A FW
#define	OISFW_RELEASE_VER (0xA3A3)	//LC898122A FW
//#include  <windows.h>
...
#define		E2POFST				0x0800
/****************** page ******************/
#define		MAX_HALL_BEFORE_X		(0x0000 + E2POFST)		// X Max Hall Adjust Value Before
#define		MIN_HALL_BEFORE_X		(0x0002 + E2POFST)		// X Min Hall Adjust Value Before
#define		MAX_HALL_BEFORE_Y		(0x0004 + E2POFST)		// Y Max Hall Adjust Value Before
#define		MIN_HALL_BEFORE_Y		(0x0006 + E2POFST)		// Y Min Hall Adjust Value Before
...
/* AF Open parameter */
#define		RWEXD1_L_AF		0x0DDA      //0x7FFF		//
#define		RWEXD2_L_AF		0x7FFF      //0x3e4e		//0x5A00
#define		RWEXD3_L_AF		0x1762  	//0x7FFF		//0x7000
#define		FSTCTIME_AF		0xDF        //d6	//0xd4		//0x5F
#define		FSTMODE_AF		0x00		//
#define		LTHDHL_AF		0x0082		//2014.05.19
...
//#define		GYRLMT3_S1		0x3F333333		//0.7F	pm 1.38[deg]
//#define		GYRLMT3_S2		0x3F333333		//0.7F	pm 1.38[deg]
//#define		GYRLMT3_S1		0x3F1C5149		//0.61F	pm 1.2[deg]
//#define		GYRLMT3_S2		0x3F1C5149		//0.61F	pm 1.2[deg]
//#define		GYRLMT3_S1		0x3EEA79EE		//0.457F	pm 0.9[deg]		//140314
//#define		GYRLMT3_S2		0x3EEA79EE		//0.457F	pm 0.9[deg]
//#define		GYRLMT3_S1		0x3EE66666		//0.45F
//#define		GYRLMT3_S2		0x3EE66666		//0.45F
//#define		GYRLMT3_S1		0x3ED70A3D		//0.42F pm 0.7[deg] MP sample
//#define		GYRLMT3_S2		0x3ED70A3D		//0.42F pm 0.7[deg] MP sample
#define		GYRLMT3_S1		0x3EE66666		//0.45F pm 0.7[deg] MP 2ND sample
#define		GYRLMT3_S2		0x3EE66666		//0.45F pm 0.7[deg] MP 2ND sample

 #define		GYRLMT4_S1		0x40E36733 	// 7.106F  pm 2.0  [deg] 2014.05.19
 #define		GYRLMT4_S2		0x40E36733	// 7.106F  pm 2.0  [deg] 2014.05.19

 #define		GYRA12_HGH		0x40CCA9AE	// 6.395F  pm 1.80 [deg] 2014.05.19
 #define		GYRA12_MID		0x3F636733	// 0.888F  pm 0.250[deg]
 #define		GYRA34_HGH		0x40A4DE05	// 5.152F  pm 1.45 [deg]
 //#define		GYRA34_MID		0x409F2EA4	// 4.974F  pm 1.4  [deg]
 //#define		GYRA34_MID		0x40636733	// 3.553F  pm 1.0  [deg]
 #define		GYRA34_MID		0x4035EC29	// 2.843F  pm 0.8  [deg]		//140314
 #define		GYRA34_MID_M	0x3F636733	// 0.888F  pm 0.250[deg]
...
K7_OISINI__ unsigned long	UlH1Coefval ;		// H1 coefficient value
 ...
 #define		STILLMODE	0x00
  ...
  #define		MAXLMT		0x401F2EA4				// 2.48722 (pm 0.7000)  //3F7FD000(0.99927)
  #define		MINLMT		0x00000000				// 0.00000(pm 0.0000)  // 3F7FF000(0.99976)
  #define		CHGCOEF		0xB71A639E				// -0.00001
  //#define		MAXLMT		0x40400000				// 3.0
  //#define		MINLMT		0x00000000				// 0.0
  //#define		CHGCOEF		0xB72AAAAB				// -0.00001017
 
 #define		MAXLMT_MOV	0x409F2EA4				// 4.97444 (pm 1.4000)  //3F7F2000(0.99658)
 #define		MINLMT_MOV	0x00000000				// 0.00000(pm 0.0000)  // 3F7FF000(0.99976)
 //#define		CHGCOEF_MOV	0xB861269C				// -0.00005
 #define		CHGCOEF_MOV	0xB7C0FC86				// -0.00002		//140314
#endif
