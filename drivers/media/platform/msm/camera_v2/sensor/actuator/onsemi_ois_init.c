...
#ifdef	INI_SHORT1
K7_OISINI__ const struct STFILRAM	CsFilRam[] = {
...
#else	//INI_SHORT1
/* 32bit */
K7_OISINI__ const struct STFILRAM	CsFilRam[][FILRAMTAB]	= {
	{
...
int	IniFil( void )
{
	...
	{
	#ifdef	ATMEL
		RamWriteA_Ex( CsFilRam[ UsAryId ].UsRamAdd, (unsigned char*)(&(CsFilRam[ UsAryId ].UsRamAdd)), CsFilRam[ UsAryId ].UcRamDat_len+2) ;
	#else	//ATMEL
		RamWriteA_Ex( CsFilRam[ UsAryId ].UsRamAdd, (unsigned char*)(CsFilRam[ UsAryId ].UcRamDat), CsFilRam[ UsAryId ].UcRamDat_len) ;
	#endif	//ATMEL
		UsAryId++ ;
