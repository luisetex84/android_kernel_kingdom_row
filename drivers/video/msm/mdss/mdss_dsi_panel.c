...
static struct dsi_cmd_desc backsre_cmd = {
							...
							u32 bl_level)
{
	...
	/*
	 * Some backsre controllers specify a minimum duty cycle
	 * for the backsre brightness. If the brightness is less
