...
/**
 * check_last_request_initiator- driver can check this value to decide next step
 * return: last request initiator
 */
extern enum nl80211_reg_initiator check_last_request_initiator(void);
