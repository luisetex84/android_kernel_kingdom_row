			     ...
			     enum nl80211_reg_initiator reg_initiator)
{
	...
	/* Need callback wiphy->reg_notifier for some driver may pending here */
	if (r == -EALREADY && wiphy ) {
...
enum nl80211_reg_initiator check_last_request_initiator(void)
{
	enum nl80211_reg_initiator last_rqeuest_initiator = NL80211_REGDOM_SET_BY_CORE;
	if(last_request)
		last_rqeuest_initiator = last_request->initiator;
	return last_rqeuest_initiator;
}
EXPORT_SYMBOL(check_last_request_initiator);
